...
Online information spreads rapidly, making it difficult for users to distinguish reliable news from misleading or suspicious claims. Manual verification is slow and inconsistent.
\end{block}
